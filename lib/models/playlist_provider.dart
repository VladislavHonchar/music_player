 ...
 */
  ...
  // seek to a specific podition in the current song
  ...
  void playPreviousSong() async{
    // if more than a seconds have passed, restart the current song
    if(_currentDuration.inSeconds > 2){
      seek(Duration.zero);
    }
    // if it`s within 2 second of the song, go to the previous song
    else{
      if(_currentSongIndex! > 0){
        currentSongIndex = _currentSongIndex! - 1;
      }else{
        // if i`ts the first song loop back to last song
